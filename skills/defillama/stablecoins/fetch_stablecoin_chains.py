...
class CirculatingUSD(BaseModel):
    ...
    peggedUSD: Optional[float] = Field(
        None,
        description="Amount pegged to USD"
    )
    peggedEUR: Optional[float] = Field(
        None,
        description="Amount pegged to EUR"
    )
    peggedVAR: Optional[float] = Field(
        None,
        description="Amount in variable pegs"
    )
    peggedJPY: Optional[float] = Field(
        None,
        description="Amount pegged to JPY"
    )
    peggedCHF: Optional[float] = Field(
        None,
        description="Amount pegged to CHF"
    )
    peggedCAD: Optional[float] = Field(
        None,
        description="Amount pegged to CAD"
    )
    peggedGBP: Optional[float] = Field(
        None,
        description="Amount pegged to GBP"
    )
    peggedAUD: Optional[float] = Field(
        None,
        description="Amount pegged to AUD"
    )
    peggedCNY: Optional[float] = Field(
        None,
        description="Amount pegged to CNY"
    )
    peggedREAL: Optional[float] = Field(
        None,
        description="Amount pegged to Brazilian Real"
    )
...
class ChainData(BaseModel):
    ...
    gecko_id: Optional[str] = Field(
        None,
        description="CoinGecko ID of the chain"
    )
...
class FetchStablecoinChainsResponse(BaseModel):
    ...
    chains: List[ChainData] = Field(
        ...
        description="List of chains with their stablecoin data"
    )
