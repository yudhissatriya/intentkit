...
class ProtocolMethodology(BaseModel):
    ...
    ProtocolRevenue: Optional[str] = Field(None, description="Description of protocol revenue")
    HoldersRevenue: Optional[str] = Field(None, description="Description of holders revenue")
    SupplySideRevenue: Optional[str] = Field(None, description="Description of supply side revenue")
